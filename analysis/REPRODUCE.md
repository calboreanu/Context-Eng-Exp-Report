...
The public files permit independent verification of released aggregate arithmetic and mapping, not regeneration of the raw source frame. Passing the automated boundary validator is necessary but not sufficient for release. A named disclosure reviewer must still inspect the exact commit, workbook, manifest, and archive before any public deposit.
